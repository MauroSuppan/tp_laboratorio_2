...
namespace TestUnitario
{
    ...
    public class UnitTest
    {
        ...
        public void DNI_Invalido_Texto()
        {
            ...
            try
            {
                Alumno alu = new Alumno(65, "Pepe", "Rodriguez", dniComa, Persona.ENacionalidad.Argentino, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
            ...
            // DNI con texto
            string dniTexto = "37asd078";
            try
            {
                Alumno alu = new Alumno(65, "Pepe", "Rodriguez", dniTexto, Persona.ENacionalidad.Argentino, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
        ...
        public void DNI_Invalido_Bajo()
        {
            ...
            try
            {
                Alumno alu = new Alumno(65, "Pepe", "Rodriguez", dniBajo.ToString(), Persona.ENacionalidad.Argentino, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
            ...
            try
            {
                Alumno alu = new Alumno(65, "Pepe", "Rodriguez", dniBajo.ToString(), Persona.ENacionalidad.Extranjero, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
                Assert.Fail("Sin excepción para DNI inválido: {0}.", dniBajo);
            }
            catch (Exception e)
            {
        ...
        public void DNI_Invalido_Alto()
        {
            ...
            try
            {
                Alumno alu = new Alumno(65, "Pepe", "Rodriguez", dniAlto.ToString(), Persona.ENacionalidad.Argentino, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
            ...
            try
            {
                Alumno alu = new Alumno(65, "Pepe", "Rodriguez", dniAlto.ToString(), Persona.ENacionalidad.Extranjero, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
                Assert.Fail("Sin excepción para DNI inválido: {0}.", dniAlto);
            }
            catch (Exception e)
            {
        ...
        public void DNI_Valido_Argentino()
        {
            ...
            Alumno alu = new Alumno(65, "Pepe", "Rodriguez", dniMedio.ToString(), Persona.ENacionalidad.Argentino, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
            // Cargó OK?
            Assert.AreEqual(alu.DNI, dniMedio);

            // Primer DNI válido
            int dniPrimero = 1;
            alu = new Alumno(65, "Pepe", "Rodriguez", dniPrimero.ToString(), Persona.ENacionalidad.Argentino, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
            // Cargó OK?
            Assert.AreEqual(alu.DNI, dniPrimero);

            // Último DNI válido
            int dniUltimo = 89999999;
            alu = new Alumno(65, "Pepe", "Rodriguez", dniUltimo.ToString(), Persona.ENacionalidad.Argentino, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
            // Cargó OK?
        ...
        public void DNI_Valido_Extranjero()
        {
            ...
            Alumno alu = new Alumno(65, "Pepe", "Rodriguez", dniMedio.ToString(), Persona.ENacionalidad.Extranjero, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
            // Cargó OK?
            Assert.AreEqual(alu.DNI, dniMedio);

            // Primer DNI válido
            int dniPrimero = 90000000;
            alu = new Alumno(65, "Pepe", "Rodriguez", dniPrimero.ToString(), Persona.ENacionalidad.Extranjero, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
            // Cargó OK?
            Assert.AreEqual(alu.DNI, dniPrimero);

            // Último DNI válido
            int dniUltimo = 99999999;
            alu = new Alumno(65, "Pepe", "Rodriguez", dniUltimo.ToString(), Persona.ENacionalidad.Extranjero, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
            // Cargó OK?
            Assert.AreEqual(alu.DNI, dniUltimo);
        }
        ...
        {
            Alumno alu = new Alumno(65, "Pepe", "Rodriguez", "37143078", Persona.ENacionalidad.Argentino, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
            // Es nulo alu?
        ...
        {
            Instructor ins = new Instructor(25, "Pepe", "Rodriguez", "37143078", Persona.ENacionalidad.Argentino);
            // Es nulo ins?
        ...
        public void Alumno_Repetido()
        {
            ...
            {
                Gimnasio gim = new Gimnasio();
                Alumno alu1 = new Alumno(65, "Pepe", "Rodriguez", "37143078", Persona.ENacionalidad.Argentino, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
                Alumno alu2 = new Alumno(66, "Pepito", "Rodriguez", "37143078", Persona.ENacionalidad.Argentino, Gimnasio.EClases.CrossFit, Alumno.EEstadoCuenta.AlDia);
            ...
            try
            {
                Gimnasio gim = new Gimnasio();
                Alumno alu1 = new Alumno(65, "Pepe", "Rodriguez", "37143078", Persona.ENacionalidad.Argentino, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.AlDia);
                Alumno alu2 = new Alumno(65, "Pepito", "Rodriguez", "40000000", Persona.ENacionalidad.Argentino, Gimnasio.EClases.CrossFit, Alumno.EEstadoCuenta.AlDia);
        ...
        public void SinInstructor()
        {
            try
            {
                ...
                Instructor ins1 = new Instructor(65, "Pepe", "Rodriguez", "37143078", Persona.ENacionalidad.Argentino);
